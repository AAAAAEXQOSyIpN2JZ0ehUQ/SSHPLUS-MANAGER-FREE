...
if($achou==0){
		...
		echo	'window.location="../../home.php?page=usuario/usuario_ssh";';
		echo '</script>';
		exit;
...
//Insere fatura
$faturains = "insert into fatura (usuario_id,tipo,qtd,data,datavencimento,status,descrição,valor,desconto) values ('".$ssh['id_usuario']."','outros','1','".$data."','".$dataexpire."','pendente','".$desc."','".$valorssh."','0')";
