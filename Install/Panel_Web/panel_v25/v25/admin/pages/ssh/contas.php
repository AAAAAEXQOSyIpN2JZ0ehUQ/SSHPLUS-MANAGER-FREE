                                        ...
                                        <tr <?php echo $color; ?>>
                                            ...
                                            <td>
                                                <span class="pull-left-container" style="margin-right: 3px;">
                                                    <span class="badge badge-<?php echo $sts; ?> pull-left">
                                                        <?php echo $row['nome']; ?>
                                                    </span>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <a href="home.php?page=ssh/editar&id_ssh=<?php echo $row['id_usuario_ssh']; ?>" <?php echo $class; ?>><i class="fad fa-eye white"></i></a>
                                                    <?php if (($revendedor['tipo'] == 'vpn') and ($owner <> 'Sistema')) { ?> <a data-toggle="modal" href="#squarespaceModal<?php echo $row['id_usuario_ssh']; ?>" class="btn-sm btn-success label-warning"><i class="fad fa-shopping-cart white"></i></a><?php } else { ?><?php } ?>
                                                </div>
                                            </td>
                                        </tr>
