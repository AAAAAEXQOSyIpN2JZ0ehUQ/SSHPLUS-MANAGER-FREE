...
<footer class="footer footer-static footer-light">
    <center><p class="clearfix blue-grey lighten-2 mb-0">
        <span class="center">
			<center> © <script>document.write(new Date().getFullYear())</script> | <a href="http://www.vip-vps.com.br/" target="_blank" class="text-info m-l-5"><b>VIP-VPS V.25</b></a><br>TODOS DIREITOS RESERVADOS</center>
        </span>
