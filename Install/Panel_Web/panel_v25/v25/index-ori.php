...
<head>
    ...
    <meta name="keywords" content="VPN NETPLUS, VPS, SSH, Gratis, login">
    <meta name="author" content="JOSE RODRIGUES">
    <meta name="msapplication-TileColor" content="#7367F0">
    <meta name="theme-color" content="#7367F0">
    <title>NETPLUS - Cliente</title>
                            ...
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    <div class="card-header pb-1">
                                        ...
                                        <center><img width="100" height="70" src="https://i.imgur.com/Cl0lHmm.png"></center>
                                        </div>
                                    </div>
