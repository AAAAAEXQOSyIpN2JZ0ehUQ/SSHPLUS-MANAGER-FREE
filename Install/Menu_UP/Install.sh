...
wget -O /bin/ferramentascodes https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/SSHPLUS-MANAGER-FREE/master/Install/Menu_UP/ferramentascodes; chmod +x /bin/usercodes
cd && rm -rf Install.sh