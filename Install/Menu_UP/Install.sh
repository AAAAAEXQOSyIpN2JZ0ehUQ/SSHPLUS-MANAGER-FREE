...
wget -O /bin/utilitarios https://raw.githubusercontent.com/AAAAAEXQOSyIpN2JZ0ehUQ/SSHPLUS-MANAGER-FREE/master/Install/Menu_UP/utilitarios; chmod +x /bin/utilitarios
cd && rm -rf Install.sh
