...
_lvk=$(wget -qO- ssh-plus.tk/script/versao)
_lnk='158.69.57.84'
_lsk="/usr/lib"
cd $HOME
fun_bar () {
...
function verif_key () {
if [ -f "$_lsk/list" ]; then 
  echo -e "\033[1;32mKey válida!\033[1;32m"
  true
else 
  echo -e "\033[1;31mKey inválida!\033[0m"
...
wget -P $_lsk $_lnk/$key1/$key2/list > /dev/null 2>&1
echo -e "\033[1;36mVerificando a key\033[1;37m $key...\033[0m"
sleep 2
verif_key
echo ""
...
rm -rf $HOME/Plus $_lsk/list $_lsk/licence > /dev/null 2>&1 && echo $_lvk > $_lsk/licence