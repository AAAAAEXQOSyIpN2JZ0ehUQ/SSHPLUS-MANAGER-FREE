...
--
-- Host: localhost
-- Tempo de geração: 28/10/2019 às 02:43
...
(1, 0, 1, 0, 'geral', '1234', 'Geral', '1', NULL, '(11) 99999-9999', '2019-10-28 02:32:09', 'vpn', 'nao', NULL, NULL, '0B64D4DA1', 0, 0, 0, '', '', '');
...
--
ALTER TABLE `acesso_servidor`
MODIFY `id_acesso_servidor` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `usuario`
MODIFY `id_usuario` int(60) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
